...
public class CipherSaber2 extends Utility{
    ...
    public char [] encrypt(String messageStr, char [] key) throws InvalidKeyException {
     ...
     * r rounds of key scheduling */
    public String decrypt(char [] cipherText, char [] key) throws InvalidKeyException {
    ...
    private void checkKeyLength(char [] key) throws InvalidKeyException {
